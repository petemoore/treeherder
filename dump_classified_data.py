...
from treeherder.model.models import (BugJobMap, BuildPlatform, FailureLine,  # noqa: E402
                                     Job, JobGroup, JobType, TextLogError,
                                     TextLogStep, Machine, MachinePlatform,
                                     Push, Product, ReferenceDataSignatures,
                                     Repository, RepositoryGroup, FailureClassification)
...
recent_maps = BugJobMap.objects.order_by('-created').only('job_id')[:100]
